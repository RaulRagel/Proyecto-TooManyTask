...
public class ContractBTDTO {
    ...
    public ContractBTDTO(Long id, String name, String beneficiary, LocalDate createdAt, List<TaskDTO> taskList, int tasks, Long totalHours, Long totalInvested, Long totalInvestedAux, Long availableHours, List<HoursBagDTO> hourBagsList, int hourBags, List<String> warningList, int warnings) {
        this.id = id;
        this.name = name;
